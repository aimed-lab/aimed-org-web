  ...
  return (
    <input
      ...
      className={cn(
        ...
        "dark:border-zinc-800 dark:bg-zinc-950 dark:text-slate-100 dark:placeholder:text-slate-500 dark:file:text-slate-100 dark:focus-visible:ring-offset-zinc-950",
        className
      )}
      ref={ref}
      {...props}
