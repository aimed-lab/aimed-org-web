    ...
    <div className="min-h-screen bg-white dark:bg-zinc-950">
      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-emerald-50 to-white dark:from-zinc-900 dark:to-zinc-950 py-16 sm:py-20 md:py-36">
        <div className="mx-auto max-w-4xl px-6 text-center">
          ...
          >
            <div className="mb-4 inline-flex items-center gap-2 rounded-full bg-violet-100 dark:bg-violet-900/40 px-4 py-2 text-sm font-medium text-violet-800 dark:text-violet-300">
